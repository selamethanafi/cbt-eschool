...
<body>
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <?php
                                ...
                                $kelas = $_POST['kelas'];
                                $rombel = $_POST['rombel'];
                                $nama_ujian = htmlspecialchars($_POST['nama_ujian']);
                            ...
                            <div class="card">
                                ...
                                <div class="card-body" id="canvas_div_pdf">
                                    <div class="text-center" style="margin-bottom: 10px;">
                                        <h3 style="margin-bottom: 5px;">DAFTAR HADIR</h3>
                                        <h4 style="margin-bottom: 5px;"><?= strtoupper($nama_ujian) ?></h4>
                                        <h5 style="margin-bottom: 0;"><?= strtoupper($nama_sekolah) ?></h5>
                                    </div>
    ...
    function exportPDF() {
        ...
        html2pdf().set({
            margin: 0.2,
            filename: 'DaftarHadir_Ujian.pdf',
            image: {
                type: 'jpeg',
                quality: 1
            },

...
include '../inc/dataadmin.php';
    ...
    FROM soal s
    LEFT JOIN butir_soal b ON s.kode_soal = b.kode_soal where `status` = 'Aktif'
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Konfirmasi Menonaktifkan Tes</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        Yakin hendak menonaktifkan semua tes?
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
        <a href="nonaktifkan_semua_tes.php" class="btn btn-success">Yakin</a>
      </div>
    </div>
  </div>
</div>
